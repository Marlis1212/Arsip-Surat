...
<head>
    ...
    <title>Arsip Surat Madawat - Laporan Surat Masuk</title>
    ...
    <script>
        ...
        function keluar() {
            window.location.href = 'logout.php'; // Ganti dengan logout.php atau URL logout yang sesuai
        }
...
<body>
    ...
    <div class="isi">
        ...
        <div class="kotak">
            <div class="atas">
                <p>Cetak Laporan Surat Masuk</p>
            </div>

            <hr>

            <form method="POST" action="prosesLaporansuratmasuk.php">
                <div class="kotak1">
