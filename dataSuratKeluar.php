        ...
        <div class="kotak">
            <div class="atas">
                ...
                <div class="tambahSurat">
                    <a href="tambahSuratkeluar.php"> <button class="btn-tambah-surat"><i class="fa fa-fw fa-plus"></i>Tambah Surat Keluar</button></a>
                </div>
            </div>
                    ...
                    <div class="tbl"> 
                        <table border="3">
                            ...
                            if (isset($_POST['cari'])) {
                                ...
                                $sql = $koneksi->query("SELECT * FROM suratkeluar WHERE no_urut LIKE '%$keyword%' OR alamat_pengirim LIKE '%$keyword%'");
                            } else {
                            ...
                            <tr>
                                ...
                                <td><?php echo $data['no_petunjuk']; ?></td>
                                <td>
                                    <!-- Tombol untuk mengubah dan menghapus data surat keluar -->
                                    <a href="ubahDataSuratkeluar.php?aksi=UBAH&id_suratkeluar=<?php echo $data['id_suratkeluar']; ?>"> <button class="btn-ubah"><i class="fa fa-fw fa-edit"></i></button></a>
                                    <a href="prosesDataSuratkeluar.php?aksi=HAPUS&id_suratkeluar=<?php echo $data['id_suratkeluar']; ?>" onclick="return confirm('Anda yakin ingin menghapus data ini?')"> <button class="btn-hapus"><i class="fa fa-fw fa-trash"></i></button></a>
                                </td>
                            </tr>
                            <?php } ?>
                        </table>
